...
public class UserServiceController {
	...
	@GetMapping("/alumni-verification/pending")
	public List<VerifyAlumniModel> getPendingAlumniVerification() {
		return verifyAlumniRepository.findAllByIsDeleteEqualsAndStatusEquals(false,
				VerifyAlumniModel.Status.PENDING);
	}
	
	@GetMapping("/alumni-verification/resolved")
	public List<VerifyAlumniModel> getResolvedAlumniVerification() {
		return verifyAlumniRepository.findAllByIsDeleteEqualsAndStatusNot(false,
				VerifyAlumniModel.Status.PENDING);
	}
	...
	public ResponseEntity<String> createAlumniVerification(@RequestHeader("userId") String userId,
		...
		user.setId(userId);
		VerifyAlumniModel verifyAlumni = new VerifyAlumniModel(user, student_id, beginning_year, social_media_link);
